...
public class SoapClient {
	public static void main(String[] args) throws ParseException, MalformedURLException {
		QName qName = new QName("http://service.base.com/","HelloService");
		HelloService helloService = new HelloService(new URL("http://127.0.0.1:8080/com.base.webservice.server.helloService?wsdl"),qName);
