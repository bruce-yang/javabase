...
public class ChineseSpellingUtils {
	...
	/////调用方法///
	public static String getSpellFromChinese(String chinese){
		return ChineseSpellingUtils.getInstance().getSelling(chinese);
	}
